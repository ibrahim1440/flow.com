...
| **Admin reset** | Full operational data reset behind three independent guards: `settings.reset` sub-privilege + confirmation phrase + admin PIN re-verify. FK-safe deletion order. Catalog and config data preserved. |
